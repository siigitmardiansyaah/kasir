          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <div class="form-inline">
                <select id="barcode" class="form-control select2 col-sm-6" onchange="getNama()" required></select>
            ...
            <div class="form-group">
              <label>Jumlah</label>
              <input type="number" class="form-control col-sm-6" placeholder="Jumlah" id="jumlah" onkeyup="checkEmpty()" required>
            </div>
            <div class="form-group">
