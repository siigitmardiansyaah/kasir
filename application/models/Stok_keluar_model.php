...
class Stok_keluar_model extends CI_Model {
	...
	{
		$this->db->select('stok_keluar.tanggal, stok_keluar.jumlah, stok_keluar.keterangan, produk.kode_produk, produk.nama_produk');
		$this->db->from($this->table);
		$this->db->join('produk', 'produk.id = stok_keluar.id_produk');
		return $this->db->get();
	}
